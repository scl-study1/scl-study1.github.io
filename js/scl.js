...
function make_slides(f) {
  ...
  slides.conditionThree2 = slide({
    name : "conditionThree2",
    start: function() {

      document.getElementById('myVideo3R').addEventListener('ended',myHandler,false);
      function myHandler(e) {
  ...
  button : function() {
    document.getElementById('start-video').play() ;
    document.getElementById('myVideo3R').play()
    //exp.go(); //use exp.go() if and only if there is no "present" data.
  } // remove for actual
...
slides.intentionR = slide({
  ...
  present : randomSort([
    ...
    {sentence: "Was Brock-bot aiming to clean the room?"} //goalClean
  ]),
  ...
  present_handle : function(stim) {
    ...
    $(".prompt").html(stim.sentence);
    //erase current value
    document.getElementById('opt1IR').checked = false;
    document.getElementById('opt2IR').checked = false;
    document.getElementById('opt3IR').checked = false;
    document.getElementById('opt4IR').checked = false;
    document.getElementById('opt5IR').checked = false;
    document.getElementById('opt6IR').checked = false;
    document.getElementById('opt7IR').checked = false;
...
slides.intentionM = slide({
  ...
  present : randomSort([
    ...
    {sentence: "Was Brock aiming to open the door?"}, //goal
    {sentence: "Was Brock aiming to clean the room?"} ,//goalClean
    {sentence: "What is the likelihood that the vacuum-bot had the intention to open the door?"}, //intention
    {sentence: "How likely is it that the vacuum-bot knew how to open the door?"}, //knowledge
    {sentence: "Was the vacuum-bot aiming to open the door?"}, //goal
    {sentence: "Was the vacuum-bot aiming to clean the room?"}//goalClean
  ...
  present_handle : function(stim) {
    ...
    $(".prompt").html(stim.sentence);
    //erase current value
    document.getElementById('opt1IM').checked = false;
    document.getElementById('opt2IM').checked = false;
    document.getElementById('opt3IM').checked = false;
    document.getElementById('opt4IM').checked = false;
    document.getElementById('opt5IM').checked = false;
    document.getElementById('opt6IM').checked = false;
    document.getElementById('opt7IM').checked = false;
